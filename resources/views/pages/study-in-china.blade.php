...
<section class="section" style="background:var(--paper);">
    <div class="wrap">
        ...
        $partners = [
            ...
            ['abbr'=>'SDUT','uni'=>'Shandong University of Technology','zh'=>'山东理工大学','crest'=>'山理','type'=>'Public','location'=>'Zibo · Shandong','founded'=>'1956','students'=>'34k','intl'=>'1,000','popular'=>'Mechanical Engineering · Electrical · Computer Science · Chemical Engineering','tuition'=>'USD 2.5 – 4.5k','tag'=>'Engineering','website'=>route('china.sdut'),'target'=>'_self','logo'=>'sdut.jpg','phA'=>'#34526e','phB'=>'#1a2a3e'],
            ['abbr'=>'JUFE','uni'=>'Jiangxi University of Finance and Economics','zh'=>'江西财经大学','crest'=>'江财','type'=>'Public','location'=>'Nanchang · Jiangxi','founded'=>'1923','students'=>'40k','intl'=>'1,500','popular'=>'Finance · Accounting · International Business · Economics','tuition'=>'USD 3 – 6k','tag'=>'Finance · Business','website'=>route('china.jufe'),'target'=>'_self','logo'=>'jufe.jpg','phA'=>'#a51717','phB'=>'#3d0808'],
            ['abbr'=>'HMU','uni'=>'Hainan Medical University','zh'=>'海南医科大学','crest'=>'海医','type'=>'Public','location'=>'Haikou · Hainan','founded'=>'1947','students'=>'15k','intl'=>'1,200','popular'=>'MBBS (English) · Clinical Medicine · Nursing · Pharmacy','tuition'=>'USD 3 – 6k','tag'=>'Medical · MBBS','website'=>route('china.hmu'),'target'=>'_self','logo'=>'hmu.jpg','phA'=>'#2a8a6a','phB'=>'#0e3527'],
        ];
        @endphp
