...
<section class="section" x-data="countryTabs()">
    <div class="wrap">
        ...
        @php
        $panels = [
            'china'     => ['name'=>'China',               'label'=>'BEIJING · 北京',       'phA'=>'#a51717','phB'=>'#3d0808','blurb'=>'The largest higher-education system in the world. World-class research, generous scholarships and the fastest-growing alumni network in Asia.',       'stats'=>[['280+','Partner universities'],['1,200+','Programmes'],['¥0','Tuition (full-ride)'],['48 hrs','Avg. response']], 'unis'=>[['Tsinghua University','Beijing · QS #20'],['Peking University','Beijing · QS #14'],['Fudan University','Shanghai · QS #39'],['Zhejiang University','Hangzhou · QS #47'],['Shanghai Jiao Tong','Shanghai · QS #45']], 'href'=>route('china'),    'zh'=>'中国'],
