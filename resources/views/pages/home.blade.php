...
<section class="section" x-data="countryTabs()">
    <div class="wrap">
        ...
        $panels = [
            ...
            'indonesia' => ['name'=>'Indonesia',           'label'=>'JAKARTA · ID',         'phA'=>'#c98a1d','phB'=>'#5e3f10','image'=>'jakarta.jpeg',   'blurb'=>'Newly opened destination with strong programmes in business, hospitality and Southeast Asian studies. Direct cohorts launching from 2026.',          'stats'=>[['32+','Partner universities'],['220+','Programmes'],['IDR 60M','From / year'],['96 hrs','Avg. response']],  'unis'=>[['Universitas Indonesia','Depok · QS #237'],['Institut Teknologi Bandung','Bandung · QS #281'],['Universitas Gadjah Mada','Yogyakarta · QS #239'],['Universitas Airlangga','Surabaya · QS #345'],['Bina Nusantara University','Jakarta · QS #701']], 'href'=>'#',               'zh'=>'印度尼西亚'],
            'future'    => ['name'=>'Future Destinations', 'label'=>'EXPANDING · ASIA',     'phA'=>'#3a3f56','phB'=>'#15182a','image'=>null,              'blurb'=>'Coming soon — Singapore, Hong Kong, Thailand and Vietnam. Join the waitlist and be first to access pilot cohorts in 2027.',                        'stats'=>[['4','New destinations'],['2027','Pilot launch'],['Free','Waitlist'],['—','Coming soon']],                   'unis'=>[['Singapore','Pilot · 2027'],['Hong Kong SAR','Pilot · 2027'],['Thailand','Pilot · 2027'],['Vietnam','Pilot · 2028'],['Korea (under review)','Pilot · 2028']], 'href'=>'#',               'zh'=>'未来'],
        ];
        @endphp
