...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&family=DM+Sans:ital,wght@0,300;0,400;0,500;1,400&family=DM+Mono:wght@400;500&display=swap" rel="stylesheet">
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: 'DM Sans', sans-serif; background: #f5f5f0; color: #1a1a2e; padding: 40px 20px; }
        ...
        .receipt-header .brand { font-family: 'Outfit', sans-serif; font-size: 22px; font-weight: 400; }
        .receipt-header .brand span { color: #c0392b; font-style: italic; }
        .receipt-header .receipt-label { font-family: 'DM Mono', monospace; font-size: 10px; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(255,255,255,0.5); margin-bottom: 4px; }
        .receipt-header .receipt-num { font-family: 'Outfit', sans-serif; font-size: 20px; color: #fff; }

        .paid-bar { background: #16a34a; color: #fff; padding: 16px 32px; display: flex; justify-content: space-between; align-items: center; }
        .paid-bar .amount { font-family: 'Outfit', sans-serif; font-size: 36px; }
        .paid-bar .status { font-family: 'DM Mono', monospace; font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; background: rgba(255,255,255,0.2); padding: 4px 12px; border-radius: 999px; }

        .receipt-body { padding: 32px; }
        .section-title { font-family: 'DM Mono', monospace; font-size: 9px; letter-spacing: 0.12em; text-transform: uppercase; color: #6b7280; margin-bottom: 12px; padding-bottom: 6px; border-bottom: 1px solid #e5e7eb; }
        ...
        .total-row .label { font-family: 'DM Mono', monospace; font-size: 11px; letter-spacing: 0.08em; text-transform: uppercase; }
        .total-row .value { font-family: 'Outfit', sans-serif; font-size: 24px; }
        ...
        .print-btn { display: block; text-align: center; margin: 20px auto 0; padding: 12px 32px; background: #1a1a2e; color: #fff; border: none; font-family: 'DM Mono', monospace; font-size: 11px; letter-spacing: 0.1em; text-transform: uppercase; cursor: pointer; }
        @media print {
...
<div class="receipt">
    ...
    <div class="receipt-body">
        ...
        <div style="margin-bottom:24px;">
            ...
            <div class="row"><span class="label">Transaction ID</span><span class="value" style="font-family:'DM Mono',monospace; font-size:11px;">{{ $application->stripe_payment_id ?? '—' }}</span></div>
